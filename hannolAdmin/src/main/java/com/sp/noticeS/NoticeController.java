...
@Controller("noticeS.noticeController")
public class NoticeController {
	...
	@RequestMapping(value = "/noticeS/list")
	public String userList(@RequestParam(value = "page", defaultValue = "1") int current_page,
		...
		String query = "";
		String listUrl = cp + "/noticeS/list";
		String articleUrl = cp + "/noticeS/article?page=" + current_page;
		if (searchValue.length() != 0) {
			query = "searchKey=" + searchKey + "&searchValue=" + URLEncoder.encode(searchValue, "utf-8");
		}

		if (query.length() != 0) {
			listUrl = cp + "/noticeS/list?" + query;
			articleUrl = cp + "/noticeS/article?page=" + current_page + "&" + query;
		}
	...
	@RequestMapping(value = "/noticeS/created", method = RequestMethod.GET)
	public String created(Model model) throws Exception {
		model.addAttribute("mode", "created");
		return ".noticeS.created";
	}

	@RequestMapping(value = "/noticeS/created", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/noticeS/article")
	public String article(@RequestParam(value = "num") int num, @RequestParam(value = "page") String page,
		...
		if (dto == null) {
			return "redirect:/noticeS/list?" + query;
		}
	...
	public String updateForm(
		...
		Notice dto = service.readNotice(num);
		if(dto==null) {
			return "redirect:/noticeS/list?page="+page;
		}
	...
	@RequestMapping(value = "/noticeS/delete")
